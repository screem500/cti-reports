...
**الإبلاغ:** بتاريخ 2026-07-25 تم: إبلاغ GitHub Trust & Safety عن مستودعي SmartLoader-MaaS النشطين (تأكيد استلام وارد)، وإشعار الجهات المعنية في سلطنة عُمان ودولة قطر بالمؤشرين المرتبطين بطعومهما (omani-disputes.com / QA-HOST-01-REDACTED)
...
- **نطاقات شرعية مخترقة** ذات تسمية خليجية (`QA-HOST-01-REDACTED` — مسجل منذ 2023)
...
|---|--------|----------|------------------|-------------------|
| 1 | `QA-HOST-01-REDACTED/sonic.exe` + `/fallacy001.exe` | PureLogsStealer | قطر | offline |
...
### 3.1 QA-HOST-01-REDACTED — نطاق شرعي مخترق (ثقة متوسطة)
...
| 2026-07-14 | QA-HOST-01-REDACTED يوزع PureLogsStealer (مساران خلال 7 دقائق) |
...
| إبلاغ عن QA-HOST-01-REDACTED | المركز الوطني القطري للأمن السيبراني + PDR abuse | 🟠 عالية |
